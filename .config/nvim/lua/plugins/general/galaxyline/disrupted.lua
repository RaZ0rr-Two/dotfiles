...
gl.short_line_list = {'fern', 'NvimTree', 'vim-plug','Outline', 'LspTrouble', 'undotree' }
...
gls.left[1] = {
    ViMode = {
        ...
        highlight = { colors.darkgrey, colors.bg, 'bold' },
				-- separator = '',                    	
				-- separator_highlight = {colors.section_bg, colors.bg, 'bold'},
    },
}
...
gls.left[11] = {DiagnosticWarn = {provider = 'DiagnosticWarn', icon = '  ', highlight = {colors.orange, colors.bg}}}

gls.left[12] = {
    DiagnosticHint = {provider = 'DiagnosticHint', icon = '  ', highlight = {colors.vivid_blue, colors.bg}}
}

gls.left[13] = {DiagnosticInfo = {provider = 'DiagnosticInfo', icon = '  ', highlight = {colors.info_yellow, colors.bg}}}

gls.left[14] = {
    ShowLspClient = {
        provider = utils.lspShow, -- 'GetLspClient'
        condition = function()
